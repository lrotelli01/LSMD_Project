...
public class Room {
    ...
    private Double pricePerNightAdults;
    private Double pricePerNightChildren;
    private List<String> photos;
}
\end{minted}
...
All population scripts maintain consistency across the three databases by using the same generated IDs. This ensures that a property with a specific ID in MongoDB corresponds to the same property node in Neo4j, enabling seamless cross-database queries and operations in the application layer.
