...
\begin{itemize}
   ...
   \item The system should be able to scale to accommodate an increase in user
	traffic.
    \item The system must provide notifications via application.
    \item The bookings produced by the system must be consistent.
    \item The system must ensure high data availability on read operations.
    ...
    \item The system must use a key-value database to temporarily store information, locks, and user sessions.
...
% --- PARTE 1: ALTO (Guest) ---
% Visualizza dai pixel 1860 fino alla cima (2792)
\begin{figure}[htbp]
    \centering
    % viewport = {X_sinistra Y_basso X_destra Y_alto}
    \includegraphics[width=\textwidth, viewport={0 1860 925 2792}, clip]{images/UseCasesDiagramUML.png}
    \caption{Use cases diagram (part 1)}
\end{figure}

\clearpage

% --- PARTE 2: CENTRO (Customer) ---
% Visualizza la fascia centrale (da 930 a 1860)
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth, viewport={0 930 925 1860}, clip]{images/UseCasesDiagramUML.png}
    \caption{Use cases diagram (part 2)}
\end{figure}

\clearpage

% --- PARTE 3: BASSO (Manager) ---
% Visualizza dal fondo (0) fino a un terzo (930)
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth, viewport={0 0 925 930}, clip]{images/UseCasesDiagramUML.png}
    \caption{Use cases diagram (part 3)}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/ManagePaymentMethodView.png}
    \caption{Showing management of payment method view}
    \label{fig:comparison}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/FavoritePropertiesView.png}
    \caption{Showing Favorite properties view}
    \label{fig:comparison}
\end{figure}
...
\begin{figure}[H]
    ...
    \label{fig:comparison}
\end{figure}
\subsubsection{Manager and Customer view}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/MessagesView.png}
    \caption{Showing messages view}
    \label{fig:comparison}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/NotificationView.png}
    \caption{Showing notifications view}
    \label{fig:comparison}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Sentinel:} To ensure automatic failover, we deployed three \textbf{Redis Sentinel} instances. They monitor the cluster health and, if the Master fails, automatically promote one of the Slaves to be the new Master (in descending order of priority).
\end{itemize}
